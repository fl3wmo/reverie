...
Вы должны находится в той фракции, роль которой запрашиваете, на той должности которую указываете.
-# Примечание: Скриншот статистики обязательно нужно делать с /c 60. Действует скриншот на протяжении 24 часов.
